...
## Useful tags that are not listed ##

* [HEP-Phenomenology (hep-ph)](https://academicjobsonline.org/ajo?joblist-1-90-0----0-d--)
* [hep-ph](https://academicjobsonline.org/ajo/physics/hep-ph)
* [Phenomenology](https://academicjobsonline.org/ajo/HET/Phenomenology)

## Memos

* Jobs listed in AJO are checked (2019/10/25)
...
JSPS PD application result appeared.

### 10/4 ###

MIT Fellowship application deadline.  The research statement should be
ato most two-pages, single-sided, using an 11 or 12 point font size
