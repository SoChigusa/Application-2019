...
%%%%% Professor Name %%%%%
% \def\professorname{JoAnne Hewett}
\def\noprofessorname{} % activate this to use "To whom..."
% \def\fellowship{} % activate this if fellowship
\def\groupname{theoretical elementary particles} % high energy theory group name if exist
...
\vspace{3mm}
I would like to inquire whether there is a \ifthenelse{\isundefined{\fellowship}}{postdoctoral}{postdoctoral research fellowship} position at your \ifthenelse{\isundefined{\groupname}}{high energy theory}{\groupname} group starting in Fall 2020.
